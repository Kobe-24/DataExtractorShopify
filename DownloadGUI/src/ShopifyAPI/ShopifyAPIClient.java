...
public class ShopifyAPIClient {
	...
	public HashMap<Integer,Order> getOrders() throws ClientProtocolException, IOException	
	{
		...
		HashMap<Integer,Order> parsedResult = parseResult(resultAsString);
		
		return parsedResult;
		
	}

	private HashMap<Integer,Order> parseResult(String resultAsString) {
		HashMap<Integer,Order> parsedResult = new HashMap<Integer,Order>();
		JsonParser parser = new JsonParser();
		try {
			//parsedResult = parser.getProducts(resultAsString);
			parsedResult = parser.getOrders(resultAsString);
